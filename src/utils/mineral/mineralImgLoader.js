 ...
 */
const mineralImgGlob = import.meta.glob('/src/assets/mineral_img_data/**/*.{jpg,png,jpeg,gif}');
const mineralImgGlobB = import.meta.glob('@/assets/mineral_img_data/**/*.{jpg,png,jpeg,gif}');
